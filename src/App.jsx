...
function MainContent() {
  ...
  return (
    <div className='inforSection rounded-3xl bg-gradient-to-br xl:w-2/3 w-full sm:mr-8 xl:place-self-end from-cyan-600 to-cyan-800 p-1 sm:p-8 relative'>
      <Navbar />
      <Routes>
...
function App() {
  return (
    <BrowserRouter>
      <div className='container flex flex-col gap-6 items-start justify-start min-h-dvh p-1 sm:p-8 pb-20 relative bg-gradient-to-br from-indigo-900 via-sky-800 to-cyan-900 min-w-full'>
        <Sidebar />
        <MainContent />
      </div>
    </BrowserRouter>
